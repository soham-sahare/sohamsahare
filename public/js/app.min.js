 ...
 * Tags: soham_sahare, resume, portfolio, personal page, cv, template, one page, responsive, html5, css3, creative, clean, agency, studio
 * Version: 1.0.0
 * Build Date: July 2025
 * Last Update: July 2025
 * This product is available exclusively on Themeforest
 * Author: soham_sahare
 * Author URI: https://themeforest.net/user/soham_sahare
 * File name: app.js
 * ------------------------------------------------
...
function startLoader() {
	...
	! function a() {
		if (t < 100) {
			let r = Math.floor(15 * Math.random()) + 2;
			t = Math.min(t + r, 100), e.textContent = t;
			let o = Math.floor(40 * Math.random()) + 10;
			setTimeout(a, o)
		}
	}()
}
...
lenis.on("scroll", ScrollTrigger.update), gsap.ticker.add((e => {
	...
	$(window).scrollTop() > 10 ? $(".ss-mxd-header").addClass("is-hidden") : $(".ss-mxd-header").removeClass("is-hidden")
	...
	gsap.timeline({
		scrollTrigger: {
			trigger: ".ss-mxd-pinned-fullscreen__tl-trigger",
			start: "top 80%",
			end: "top 10%",
			scrub: {
				scrub: !0,
	...
	gsap.timeline({
		scrollTrigger: {
			trigger: ".ss-mxd-hero-07__tl-trigger",
			start: "top 86%",
			end: "top 10%",
			scrub: {
				scrub: !0,
	...
	gsap.timeline({
		scrollTrigger: {
			trigger: ".ss-mxd-hero-08__tl-trigger",
			start: "top 80%",
			end: "top 40%",
			scrub: {
				scrub: !0,
	...
	})), $(".ss-mxd-nav__wrap").each((function() {
		let e = $(this).find(".ss-mxd-nav__hamburger"),
			t = $(this).find(".hamburger__line"),
			a = $(this).find(".ss-mxd-menu__contain"),
			r = $(this).find(".hamburger__base"),
			o = $(this).find(".ss-mxd-menu__wrapper"),
			n = $(this).find(".ss-mxd-menu__base"),
			i = ($(this).find(".ss-mxd-menu__link"), $(this).find(".main-menu__item")),
	...
	})), $(".ss-mxd-nav__hamburger").on("click", (function() {
		$(".ss-mxd-nav__hamburger").hasClass("nav-open") ? $(".ss-mxd-header").addClass("menu-is-visible") : setTimeout((function() {
			$(".ss-mxd-header").removeClass("menu-is-visible")
		}), 1100)
	}));
	var e = function(e, t) {
	...
	}, new e($("#main-menu"), !1), $(".ss-mxd-projects-masonry__gallery").imagesLoaded().progress((function() {
		$(".ss-mxd-projects-masonry__gallery").masonry("layout"), ScrollTrigger.refresh()
	})), $(".ss-mxd-accordion__title").on("click", (function(e) {
		e.preventDefault();
		var t = $(this);
		t.hasClass("accordion-active") || ($(".ss-mxd-accordion__content").slideUp(400), $(".ss-mxd-accordion__title").removeClass("accordion-active"), $(".ss-mxd-accordion__arrow").removeClass("accordion-rotate")), t.toggleClass("accordion-active"), t.next().slideToggle(), $(".ss-mxd-accordion__arrow", this).toggleClass("accordion-rotate")
...
new Ukiyo(images, {
	...
	speed: 1.5,
	externalRAF: !1
}), $(".ss-mxd-pinned").each((function(e) {
	let t = $(this).find(".ss-mxd-pinned__text-item"),
		a = $(this).find(".ss-mxd-pinned__img-item");
...
const innerDemoSlider = document.querySelector("ss-mxd-demo-swiper");
innerDemoSlider || new Swiper(".ss-mxd-demo-swiper", {
	breakpoints: {
		640: {
			slidesPerView: 1,
			spaceBetween: 30
...
})), document.querySelector('[data-speed]') && gsap.to("[data-speed]", {
