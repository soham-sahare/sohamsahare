...
(function () {
	...
	var OnePageNav = function () {
		var navToggler = $('.sohamsahare-js-nav-toggle');
		$(".smoothscroll[href^='#'], #sohamsahare-navbar ul li a[href^='#']").on('click', function (e) {
			e.preventDefault();
			var hash = this.hash;
			$('html, body').animate({
		...
		$("#sohamsahare-navbar ul li a[href^='#']").on('click', function (e) {
	...
	$('.sohamsahare-js-nav-toggle').on('click', function (e) {
		var $this = $(this);
		e.preventDefault();
		if ($('body').hasClass('menu-open')) {
			$this.removeClass('active');
			$('.sohamsahare-menu .sohamsahare-menu-inner > ul > li').each(function (i) {
				var that = $(this);
				setTimeout(function () {
			...
			setTimeout(function () {
				$('.sohamsahare-menu').removeClass('sohamsahare-menu-show');
			}, 800);
			$('body').removeClass('menu-open');
		} else {
			$('.sohamsahare-menu').addClass('sohamsahare-menu-show');
	...
	$('.sohamsahare-menu .dropdown').hover(function () {
		var $this = $(this);
		$this.addClass('show');
